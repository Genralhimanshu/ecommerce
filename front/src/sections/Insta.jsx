...
const Insta = () => {
  ...
  return (
    <div className='w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4'>
      ...
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-blackf ont-semibold text-[42px] text-center capitalize'>Follow on Instagram</h1>
      ...
      <button data-aos="zoom-in" data-aos-delay="100" className='bg-themepurple hover:bg-themeyellow text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-12 uppercase'>#Insta_</button>
    </div>
  )
}
