...
const Category = () => {
  ...
  return (
    <div id='category' className='w-full bg-gray-100 lg:-20px 5px pt-[130px] pb-[80px] flex lg:flex-row flex-col justify-center items-center gap-20'>
      <div data-aos="zoom-in" data-aos-delay="50" className="lg:w-[15%] w-full flex flex-col justify-center lg:items-start items-center gap-[20px]">
        ...
        <button className='bg-themepurple 
         hover:bg-themeyellow text-white hover:text-black px-6 py-3 rounded-g font-semibold mt-[60px]'>VIEW ALL</button>
      </div>
      ...
      <div data-aos="zoom-in" data-aos-delay="100" className="flex flex-col justify-center items-center gap-6">
          ...
          <h1 className='text-black text-xl font-semibold hover:text-themepuprple cursor-pointer'>Portable Speaker</h1>
        </div>
